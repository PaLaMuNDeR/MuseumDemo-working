...
public class DistanceBeaconActivity extends Activity {
  ...
  //The distance trigger for starting new event
  private double distanceTrigger = 0.8;

    private String image_resource = "imageResource";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    //  Log.d("image",image_resource);
      ...
      int id = getResources().getIdentifier("com.estimote.examples.demos:drawable/" + image_resource, null, null);
